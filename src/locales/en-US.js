export default {
  ...
  'chart.setting.config.smooth': 'smooth line',
  'chart.setting.config.stack': 'stack chart',
  'chart.setting.config.area': 'arealine chart',
  'chart.setting.config.zoom': 'horizontal zoom toolbar',
  'chart.setting.config.zoomv': 'vertical zoom toolbar',
  'chart.setting.config.reverse': 'reverse Xaxis/yAxis',
  'chart.setting.config.pareto': 'pareto chart',
  'chart.setting.config.barshadow': 'show bar chart shadow',
  'chart.setting.config.pictorial': 'pictorial chart',
  'chart.setting.config.polar': 'polar coordinate',
  'chart.setting.config.percent': 'percent arealine chart',
  'chart.setting.config.histogram': 'histogram chart',
  'chart.setting.config.multilegend': 'allow show multy legend',
  'chart.setting.config.step': 'step line',
  'chart.setting.config.simple': 'simplify chart setting',
  'chart.setting.config.border':
    'Whether the outermost data is displayed as a line'
};
