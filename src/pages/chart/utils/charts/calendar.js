...
let chartConfig = [
  ...
  },
  {
    ...
    url: '/chart#id=17/f378da2c28&type=calendar&size=20&group=0&startmode=day&height=400&simple=1',
  },
];
...
let getVisualMap = ({ y, data, orient }) => {
...
let calendar = config => {
  ...
  return {
    tooltip: {
      trigger: 'item',
      position: 'top',
      formatter: ({ seriesName, value: [datename, val] }) =>
