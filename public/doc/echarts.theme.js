var theme = {
  ...
  title: {
    itemGap: 8,
    textStyle: { fontWeight: 'lighter', color: '#666', fontSize: 24 },
  ...
  grid: { borderWidth: 0, left: 100, right: 50, top: 60, bottom: 60 },
  categoryAxis: {
    axisLine: { lineStyle: { color: '#aaa', width: 2 } },
    boundaryGap: true,
  ...
  valueAxis: {
    ...
    axisLabel: { textStyle: { color: '#222' } },
    nameTextStyle: { fontSize: 16, color: '#555' },
    splitLine: { lineStyle: { color: ['#ddd'], width: 1, type: 'dashed' }, show: true },
    splitArea: { show: false },
  },
  timeline: {
    lineStyle: { color: 'rgb(38,185,139)' },
    controlStyle: { normal: { color: 'rgb(38,185,139)' }, emphasis: { color: 'rgb(38,185,139)' } },
  },
  bar: { itemStyle: { normal: { barBorderRadius: 1 }, emphasis: { barBorderRadius: 1 } } },
  line: {
    smooth: false,
    symbol: 'emptyCircle',
    symbolSize: 6,
  ...
  pie: {
    ...
    itemStyle: {
      normal: {
        ...
        borderWidth: 1,
        label: { show: true, position: 'inner', formatter: '{b}', textStyle: { fontSize: 12 } },
        labelLine: { show: false, length: 20, lineStyle: { width: 1, type: 'solid' } },
      },
      emphasis: {
        borderColor: 'rgba(0,0,0,0)',
        borderWidth: 1,
  ...
  force: { itemStyle: { normal: { linkStyle: { strokeColor: 'rgb(38,185,139)' } } } },
  chord: {
    padding: 4,
    itemStyle: {
      normal: {
